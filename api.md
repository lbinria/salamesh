...
| `remove_model` | Function | `(name: string)` | Removes a model by name | — |
...
| `models` | Read-only Property | — | Returns list of models | `Table[Model]` |
| `get_children_of` | Function | Likely model-related | Gets children of a model | `Table[Model]` |
...
| `focus` | Function | `(name: string)` | Focus model | — |
...
| `remove_camera` | Function | `(name: string)` | Removes a camera by name | — |
| `cameras` | Read-only Property | — | Returns camera collection | `Table[Camera]` |
...
| `clear_cameras` | Function | — | Remove all cameras from scene | — |
...
| `remove_renderer` | Function | `(name: string)` | Removes a renderer by name | — |
| `renderers` | Read-only Property | — | Returns camera collection | `Table[Renderer]` |
...
| `clear_renderers` | Function | — | Remove all renderers from scene | — |
| **Colormaps Management** |||
| `colormaps` | Read-only Property | — | Returns colormap collection | `Table[Colormap]` |
| `add_colormap` | Function | `(name: string, filename: string)` | Adds a colormap | — |
| `remove_colormap` | Function | `(name: string)` | Removes a colormap | — |
...
| `load_snapshot` | Function | — | Loads a previously created snapshot | — |
| `list_snapshots` | Function | — | Returns list of available snapshots | `Table[Snapshot]` |
| `screenshot` | Function | `(filename: string)` | Takes a screenshot | — |
| **Graphics** |||
| `setCullMode` | Function | `(mode: int)` | Sets culling mode | — |
| `cull_mode` | Write-only Property | `(mode: int)` | Sets culling mode | — |
...
| `add_navigation_path` | Function | `(path_component: string)` | Adds a path component to navigation path | — |
| `top_navigation_path` | Function | — | Go to top navigation path | — |
| **Dialogs** |||
| `show_open_model_dialog` | Function | — | Displays dialog to open a model | — |
| `show_save_model_dialog` | Function | — | Displays dialog to save a model | — |
...
| Property | Access | Type | Description |
|----------|--------|------|-------------|
| `hovered` | Read-only | `long` | Get the primitive id that is currently hovered by mouse |
| `all_hovered` | Read-only | `long list` | Get the primitive ids that are currently hovered by mouse |
| `any_hovered` | Read-only | `bool` | Indicates whether a primitive is currently hovered by mouse |
| `has_changed` | Read-only | `bool` | Indicates whether the primitive currently hovered by mouse has changed |
...
| `cursor_radius` | Read-only | `int` | Radius of the cursor |
| `dbl_click_interval` | Read-only | `int` | Time interval for detecting double-clicks |
| `is_left_button` | Read-only | `bool` | Indicated whether left mouse button is pressed |
| `is_right_button` | Read-only | `bool` | Indicated whether right mouse button is pressed |
| `is_middle_button` | Read-only | `bool` | Indicated whether middle mouse button is pressed |
| `is_button_pressed(button: int)` | Function | `bool` | Indicated whether given button is currently pressed |
| `any_button_pressed` | Read-only | `bool` | Indicated whether any button is currently pressed |
...
| `End` | Function | — | Ends the current ImGui window | — |
| **Text Rendering** |||
| `Text` | Overloaded Function | `(text: string)` or `(format: string, ...args)` | Renders text | — |
| `TextColored` | Overloaded Function | `(r,g,b,a: float, text: string)` or `(r,g,b,a: float, format: string, ...args)` | Renders colored text | — |
