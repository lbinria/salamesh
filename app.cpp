...
bool App::setup() {
	...
	std::cout << "GL_MAX_TEXTURE_IMAGE_UNITS: " << maxUnits << std::endl;

	GLint maxCombinedUnits;
	glGetIntegerv(GL_MAX_COMBINED_TEXTURE_IMAGE_UNITS, &maxCombinedUnits);
	std::cout << "GL_MAX_COMBINED_TEXTURE_IMAGE_UNITS: " << maxCombinedUnits << std::endl;
...
void App::start() {
	...
	ImGuiThemeManager::ApplyTheme(ImGuiThemeManager::nordicSkyTheme);
